                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-body">
                            ...
                            <button id={'delete-modal-delete-button'} onClick={() => { onConfirm(); onDelete(); }} className="btn btn-danger me-2">Delete</button>
                            <button id={'delete-modal-cancel-button'} onClick={onCancel} className="btn btn-secondary">Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
