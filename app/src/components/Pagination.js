...
const Pagination = ({ id, currentPage, totalPages, onNextPage, onPrevPage, setItemsPerPage, itemsPerPage, totalItems }) => {
    ...
    return (
        <div id={id} className="pagination">
            ...
            <button id={`${id}-next-button`} onClick={handleNextPage} disabled={currentPage === totalPages}>Next</button>
            <div>
                Items per page:{' '}
